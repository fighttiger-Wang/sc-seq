...
def main():
    ...
    for record in records:
        ...
        research.append([
            record.get("cluster_id", ""), record.get("celltype_en", ""),
            record.get("supporting_markers", ""), record.get("candidate_labels", ""),
            source_text, "；".join(map(str, evidence_ids)), record.get("rationale", ""),
        ])
