...
- Formal delivery: require all-cluster UMAP audit, resolved/reused research for every marker/UMAP conflict, full historical regression, versioned publication, and the unchanged three-sheet workbook.
...
UMAP is supporting evidence. It can trigger reassessment, literature search, marker-standard revision, or a new-subtype candidate; it must not independently overwrite a coherent marker identity.
